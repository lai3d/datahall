...
- **Compare designs.** Pin a hall, change it, and see what moved: GPUs, power, PUE, hardware, energy and cost, whether it powers on and how redundant it is. Swap to edit the pinned one, or paste someone's share link to compare with their hall.
