...
const VARS = {x: 3, z: 4, loc: 'L', n: 2, u: 5, kw: 800, used: 1, total: 2, m: '1.0', need: 'A', cap: 'B', heat: 'C', gpus: 7, ports: 8, facility: 'D', load: 'E', label: 'CDU', pct: 85, file: 'f.usda', reason: 'R', v: 'V', type: 'T', cell: 'T:c', name: 'N', msg: 'M', gw: 16, gd: 10, cx: .6, cz: 1.2, cur: 'K', diffs: 'P', where: 'W', id: 'I', other: 'O', line: 9, c: '"?"', expected: 'X', got: 'Y', open: '(', close: ')', reasons: 'Q', field: 'F', target: 'T', source: 'S', phase: 2, limit: 'L', gap: 7, pue: '1.2', sparks: '1,000', homes: '200', cells: 20, liq: '0.08', air: '0.30', loss: '0.05', airPue: '1.35', liqPue: '1.13', ovh: 12, lo: 190, hi: 230, ranges: 'R', date: '2026-09-18', list: 'L', steps: 'S', racks: 4, asked: '1,000', support: 3, max: 12, done: 'D', oldRacks: 12, oldGpus: '864', cdu: 3, rpp: 3, crah: 2, ib: 3, catalog: 'C', model: 'M', range: 'R', price: 30, loadBand: 20, ovhBand: 25, low: '$1.00M', high: '$2.00M', area: 12, rate: 0.0862, k: 144, gbps: 800, r: 2, leaves: 8, spines: 4, planes: 2, per: 2, placed: 3, rise: 1.2, slack: 0.5, inRack: 1, types: 'T', classes: 'C', rails: 'R', cpus: 2, psus: 6, at: '2026-09-22 15:00'};
