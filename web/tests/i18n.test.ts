...
const VARS = {x: 3, z: 4, loc: 'L', n: 2, u: 5, kw: 800, used: 1, total: 2, m: '1.0', need: 'A', cap: 'B', heat: 'C',
  ...
  c: '"?"', expected: 'X', got: 'Y', open: '(', close: ')', reasons: 'Q', field: 'F', target: 'T', source: 'S', phase: 2, limit: 'L', gap: 7, pue: '1.2', sparks: '1,000', homes: '200', cells: 20, liq: '0.08', air: '0.30', loss: '0.05', airPue: '1.35', liqPue: '1.13', ovh: 12, lo: 190, hi: 230, ranges: 'R', date: '2026-09-18', list: 'L', steps: 'S'};
